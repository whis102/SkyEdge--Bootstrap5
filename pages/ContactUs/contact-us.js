...
// Create container for contact section
...
// Create row for form elements
const formRow = document.createElement('div');
formRow.className = 'row';

// Create form group for email input
...
// Create form group for order code input
